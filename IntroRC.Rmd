...
```prolog
imprimeColor(Cosa) :- color(Cosa, Color), !, write("Es "), write(Color), write(".").
imprimeColor(Cosa) :- write("No lo sé :-/").

color(nieve, blanco).
color(cielo, amarillo).
color(Cosa, Color) :- estaHechoDe(Cosa, Material), color(Material, Color).
